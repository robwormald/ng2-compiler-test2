...
var import3 = require('angular2/src/core/linker/view');
var import4 = require('./app');
var import5 = require('angular2/src/core/linker/element');
var import6 = require('angular2/src/core/linker/view_utils');
var import8 = require('angular2/src/core/linker/view_type');
var import9 = require('angular2/src/core/change_detection/change_detection');
var import10 = require('./test.ngfactory');
var import11 = require('angular2/src/core/metadata/view');
var import12 = require('angular2/src/core/linker/component_factory');
var styles_App = [];
...
function viewFactory_App0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_App === null)) {
        (renderType_App = viewUtils.createRenderComponentType('/Users/robwormald/Dev/demos/ng2-compiler-test2/src/app.ts', 0, import11.ViewEncapsulation.None, styles_App));
    }
